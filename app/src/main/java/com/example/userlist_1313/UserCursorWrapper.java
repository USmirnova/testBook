...
//Класс-прослойка для считывания данных из б.д. и придания им нужного формата. Считываем строку с данными конкретного пользователя, преобразуем ее в объект User и возвращаем уже готовый объкт.
